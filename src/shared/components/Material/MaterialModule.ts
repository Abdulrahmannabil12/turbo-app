...
import { FormGroupMaterialComponent } from '../form-group-material/form-group-material.component';
...
// Create a new const for the timezone string
const CAIRO_TZ = "Africa/Cairo";

// Set the default timezone to Cairo
moment.tz.setDefault(CAIRO_TZ);

// Create a new const for the date format string
