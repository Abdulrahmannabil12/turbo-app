...
export class NgPagination implements OnChanges {
  ...
  @ContentChild(NgPaginationEllipsis, { static: false }) tplEllipsis: NgPaginationEllipsis = {} as NgPaginationEllipsis;
  @ContentChild(NgPaginationFirst, { static: false }) tplFirst: NgPaginationFirst = {} as NgPaginationFirst;
  @ContentChild(NgPaginationLast, { static: false }) tplLast: NgPaginationLast = {} as NgPaginationLast;
  @ContentChild(NgPaginationNext, { static: false }) tplNext: NgPaginationNext = {} as NgPaginationNext;;
  @ContentChild(NgPaginationNumber, { static: false }) tplNumber: NgPaginationNumber = {} as NgPaginationNumber;
  @ContentChild(NgPaginationPrevious, { static: false }) tplPrevious: NgPaginationPrevious = {} as NgPaginationPrevious;
