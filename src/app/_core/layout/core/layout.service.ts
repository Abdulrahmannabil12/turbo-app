...
const LAYOUT_CONFIG_LOCAL_STORAGE_KEY = `${environment.appVersion}-admin-layoutConfig`;
const BASE_LAYOUT_TYPE_LOCAL_STORAGE_KEY = `${environment.appVersion}-admin-baseLayoutType`;
